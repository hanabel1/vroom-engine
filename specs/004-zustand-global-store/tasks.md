...
- [x] T001 Install zustand via `npm add zustand` and verify it appears in dependencies in `package.json`
- [x] T002 Verify project still builds cleanly after dependency addition via `npm run build`
